<template>
  <VPLayout>
    <template #sidebar-nav-before>
      ...
      >
        <img src="https://images.brucege.com/mybatisCodeHelperPro.svg" alt="Sponsor or Ad" style="width:200px;max-width:100%;border-radius:8px;box-shadow:0 2px 8px #0001;" />
      </a>
    </template>
  </VPLayout>
</template>
