import{_ as s,a as e,o as p,g as n,I as l}from"./chunks/framework.CU_bPDjU.js";const b=JSON.parse('{"title":"Template Examples","description":"","frontmatter":{},"headers":[],"relativePath":"api/template-examples.md","filePath":"api/template-examples.md"}'),t={name:"api/template-examples.md"};function i(c,a,o,u,r,m){return p(),e("div",null,a[0]||(a[0]=[n("h1",{id:"template-examples",tabindex:"-1"},[l("Template Examples "),n("a",{class:"header-anchor",href:"#template-examples","aria-label":'Permalink to "Template Examples"'},"​")],-1),n("h2",{id:"entity-class-template",tabindex:"-1"},[l("Entity Class Template "),n("a",{class:"header-anchor",href:"#entity-class-template","aria-label":'Permalink to "Entity Class Template"'},"​")],-1),n("div",null,[n("div",{class:"language-velocity vp-adaptive-theme"},[n("button",{title:"Copy Code",class:"copy"}),n("span",{class:"lang"},"velocity"),n("pre",{class:"shiki shiki-themes github-light github-dark vp-code",tabindex:"0","v-pre":""},[n("code",null,[n("span",{class:"line"},[n("span",null,"package ${tableInfo.savePackageName};")]),l(`
